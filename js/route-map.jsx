...
const STOPS = [
  { id:'beijing', city:'Beijing', country:'China', lat:39.9042, lon:116.4074, day:1, date:'Mar 12', tag:'Departure',
    note:'Bicycle, two pannier bags, a stubborn hope.', link:'gallery.html',
    photos:[
  ...
  { id:'ulaanbaatar', city:'Ulaanbaatar', country:'Mongolia', lat:47.8864, lon:106.9057, day:21, date:'Apr 01', tag:'Steppe',
    note:'Slept under more sky than I had ever earned.', link:'gallery.html',
    photos:[
  ...
  { id:'baikal', city:'Lake Baikal', country:'Russia', lat:53.5587, lon:108.1650, day:34, date:'Apr 14', tag:'Crossing',
    note:'A train, a thermos, the longest morning of my life.', link:'gallery.html',
    photos:[
      'https://images.unsplash.com/photo-1554701745-b4a363a4e2fa?w=600&h=600&fit=crop&q=80',
      'https://images.unsplash.com/photo-1504233529578-6d46baba6d34?w=600&h=600&fit=crop&q=80',
      'https://images.unsplash.com/photo-1518623489648-a173ef7824f3?w=600&h=600&fit=crop&q=80',
      'https://images.unsplash.com/photo-1469854523086-cc02fe5d8800?w=600&h=600&fit=crop&q=80',
    ]},
  { id:'moscow', city:'Moscow', country:'Russia', lat:55.7558, lon:37.6173, day:58, date:'May 08', tag:'City',
    note:'Sunflower-seed shells on every doorstep.', link:'gallery.html',
    photos:[
  ...
  { id:'berlin', city:'Berlin', country:'Germany', lat:52.5200, lon:13.4050, day:72, date:'May 22', tag:'Rest',
    note:'Three days I planned. Three weeks I stayed.', link:'gallery.html',
    photos:[
      'https://images.unsplash.com/photo-1560969184-10fe8719e047?w=600&h=600&fit=crop&q=80',
      'https://images.unsplash.com/photo-1523906834658-6e24ef2386f9?w=600&h=600&fit=crop&q=80',
  ...
  { id:'rome', city:'Rome', country:'Italy', lat:41.9028, lon:12.4964, day:96, date:'Jun 15', tag:'Pivot',
    note:'Decided south. Sold the bike. Bought a ferry ticket.', link:'gallery.html',
    photos:[
      'https://images.unsplash.com/photo-1552832230-c0197dd311b5?w=600&h=600&fit=crop&q=80',
      'https://images.unsplash.com/photo-1523906834658-6e24ef2386f9?w=600&h=600&fit=crop&q=80',
  ...
  { id:'barcelona', city:'Barcelona', country:'Spain', lat:41.3851, lon:2.1734, day:110, date:'Jun 29', tag:'Coast',
    note:'Learned to nap on tile floors at 2 p.m.', link:'gallery.html',
    photos:[
  ...
  { id:'tangier', city:'Tangier', country:'Morocco', lat:35.7595, lon:-5.8340, day:124, date:'Jul 13', tag:'Strait',
    note:'Africa, finally — a thin line of sea between two lives.', link:'gallery.html',
    photos:[
  ...
  { id:'marrakech', city:'Marrakech', country:'Morocco', lat:31.6295, lon:-7.9811, day:131, date:'Jul 20', tag:'Arrival',
    note:'Drum, tea, the same moon. Bigger heart.', link:'gallery.html',
    photos:[
      'https://images.unsplash.com/photo-1528360983277-13d401cdc186?w=600&h=600&fit=crop&q=80',
      'https://images.unsplash.com/photo-1516026672322-bc52d61a55d5?w=600&h=600&fit=crop&q=80',
      'https://images.unsplash.com/photo-1569385210018-127585b96e85?w=600&h=600&fit=crop&q=80',
